...
function genHdrVis(proto){
	const layers={
		...
		TCP:[{l:"IP Header",c:"#3b82f6",f:["Ver","IHL","TTL","Proto=6","Src IP","Dst IP"]},{l:"TCP Header",c:"#00ddff",f:["Src Port","Dst Port","Seq Num","ACK Num","Flags(SYN/ACK/FIN/RST)","Window","Chk"]},{l:"Payload",c:"#3a6080",f:["Application Data..."]}],
...
function renderInfo(){
	...
	if(se){
		...
		const opts=LINK_CHOICES.map(k=>`<option value="${k}" ${((se.type||"auto")==
